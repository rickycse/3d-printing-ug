export const CONSTANTS = {
  ...
  SAFETY: {
    ...
    I chose to vent out because I already had my enclosure next to a window in a separate room and because I heard that HEPA and Carbon Filters don't exactly catch everything.`,
    ...
    Depending on your printer, having an enclosure might fry your motherboard if it doesn't have its own onboard fan, in which case, there are a ton of easy mods to fix this. If you have an A1 and want to throw it in an enclosure without frying it, then I would recommend checking out Billt's video on this: `,
  ...
  PROBLEMS: {
    WIP: `I wanted to make a section for common problems like the blob of death, poor bed adhesion, and more. Luckily, I haven't run into any of these issues… yet. But if I do, I'll post some solutions here as well. If you'd like to contribute, feel free to leave a message and I'll add it in!`,
